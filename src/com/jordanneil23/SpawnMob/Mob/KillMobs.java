...
public class KillMobs {
	...
	public static void Kill(Player p, String type) {
        ...
        for (LivingEntity m : w.getLivingEntities())
        {
				...
				} else if (m instanceof EnderDragon && ((type.equalsIgnoreCase("EnderDragon") || type.equalsIgnoreCase("Ender_Dragon") || type.equalsIgnoreCase("Dragon")) || (type.equalsIgnoreCase("All") || type.equalsIgnoreCase("Monsters")))) {
					m.remove();
					...
					m.remove();
				} else if (m instanceof MagmaCube && ((type.equalsIgnoreCase("Magma_Cube") || type.equalsIgnoreCase("MagmaCube")) || type.equalsIgnoreCase("All") || type.equalsIgnoreCase("Animals"))) {
					m.remove();
				}
			}
			return;
